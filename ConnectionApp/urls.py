...
urlpatterns = [
    ...
    path('update/family/identity/<int:id>/',
    ...
    path('record/new/transaction/for/<str:fname>/<str:lname>/family/<int:id>/',
         views.create_transaction, name="new_transaction"),
    path("transactions/list/", views.transactions_list, name="transactions_list"),

    path("delete/transaction/<int:id>/warning/",
         views.delete_warning_trans, name="delete_warning_trans"),
    path("delete/transaction/<int:id>/",
         views.delete_transaction, name="delete_transaction"),
    path("delete/family/identity/<int:id>/",
         views.delete_family, name="delete_family"),
    path("delete/family/identity/<int:id>/warning/",
         views.delete_warning_family, name="delete_warning_family"),
